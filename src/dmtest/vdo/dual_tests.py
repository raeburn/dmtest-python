...
from dmtest.vdo.utils import standard_vdo, GB, fsync, mounted_fs
    ...
    with standard_vdo(fix, logical_size=64 * GB) as vdo:
        ...
        try:
            ...
            def generate_worker():
                ...
                try:
                    with mounted_fs(generate_path, format=True) as mount_point:
...
def register(tests):
    tests.register("/vdo/dual/discard-during-write", t_dual)
