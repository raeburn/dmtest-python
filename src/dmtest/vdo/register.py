...
import dmtest.vdo.compress_dedupe_flags_tests as vdo_compress_dedupe_flags
...
import dmtest.vdo.dual_tests as vdo_dual
...
import dmtest.vdo.format_in_kernel_tests as vdo_format_in_kernel
...
import dmtest.vdo.thread_config_tests as vdo_thread_config
...
def register(tests):
    ...
    vdo_compress_dedupe_flags.register(tests)
    ...
    vdo_thread_config.register(tests)
