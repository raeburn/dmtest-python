...
def t_device_switch(fix) -> None:
    ...
    with dev(linear_one_table) as linear_one, dev(linear_two_table) as linear_two:
        ...
        with dev(vdo_table) as vdo:
            ...
            br_initial.write("initial", sync=True, fsync=True)
            br_initial.verify()
            ...
            br_second.write("second", sync=True, fsync=True)
            br_second.verify()
            ...
            br_dup_initial.write("initial", sync=True, fsync=True)
            ...
            br_dup_second.write("second", sync=True, fsync=True)
